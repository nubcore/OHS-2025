# Hack'd together by Beau (beau@nubcore.dk)
# https://labitat.dk/wiki/User:CaliX
# Captive portal code and license below
# This should automatically redirect to index.html
# If you get an error no internet and nothing happens
# Point a browser to 10.0.0.1 manually
...
# Change to whatever name you want, < 32 chars
SSID_NAME = "OHS2025 DEFAULT"

np = neopixel.NeoPixel(Pin(20), 2)
np[0] = (10, 0, 20) # First Addressable RGB LED
np[1] = (10, 0, 10) # Other Addressable RGB LED
np.write()
...
SERVER_SSID = SSID_NAME  # max 32 characters
SERVER_IP = '10.0.0.1'
